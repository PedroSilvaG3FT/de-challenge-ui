...
export default function SearchHeroComponent() {
  return (
    <section className="overflow-hidden relative group">
      ...
      <section className="app-container text-white h-full w-full absolute left-0 top-0 flex flex-col justify-center">
        <h4 className="text-primary font-semibold">Find your</h4>
        <h1 className="font-bold text-6xl mb-4">Next Adventure</h1>
        ...
        <FlipWords
          ...
          className="text-xl mr-2 text-white my-4 mobile:text-center"
        />
      </section>
    </section>
  );
